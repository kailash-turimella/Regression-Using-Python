...
# Importing datasets
# Make sure that the 'Salary_Data.csv' file is present in the working directory.
...
X_train,X_test,y_train,y_test = train_test_split(X,y, test_size = 1/3) # Dividing into training and test sets(Test set = 1/3 of the dataset)
...
# Evaluating Model Performance(Higher the better)
